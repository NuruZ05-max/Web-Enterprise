    ...
    <style>
        ...
        * {
        ...
        .tentang-hero::before {
            ...
            right: 0;
            bottom: 0;
            /* Menggunakan gradien yang konsisten dengan header */
        ...
        .visi-misi-container {
            ...
            gap: 30px; /* Menyelaraskan dengan gap di halaman home */
            margin-top: 50px;
        }
        ...
        .btn-layanan {
            display: inline-block;
            margin: 50px auto 0 auto; /* Menjaga margin bawah konsisten */
            background: white;
            color: #6b2d87;
...
<body style="background: white;">
    ...
    <section class="visi-misi-section">
        ...
        <div class="text-center">
            <a href="{{ url('/') }}#layanan" class="btn-layanan">LAYANAN KAMI</a>
        </div>
    </section>
